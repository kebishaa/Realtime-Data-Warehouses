...
with DAG(
    ...
    ingest_account_dim = BashOperator(
        ...
        bash_command=(
            ...
            '"http://pinot-controller:9000/ingestFromFile?tableNameWithType=account_dim_OFFLINE'
    ...
    ingest_customer_dim = BashOperator(
        ...
        bash_command=(
            ...
            '-H "Content-Type: multipart/form-data" '
            '"http://pinot-controller:9000/ingestFromFile?tableNameWithType=customer_dim_OFFLINE'
            '&batchConfigMapStr=%7B%22inputFormat%22%3A%22csv%22%2C%22recordReader.prop.delimiter%22%3A%22%2C%22%7D"'
        )
    )
    ...
    ingest_branch_dim = BashOperator(
        ...
        bash_command=(
            ...
            '-H "Content-Type: multipart/form-data" '
            '"http://pinot-controller:9000/ingestFromFile?tableNameWithType=branch_dim_OFFLINE'
            '&batchConfigMapStr=%7B%22inputFormat%22%3A%22csv%22%2C%22recordReader.prop.delimiter%22%3A%22%2C%22%7D"'
        )
    )
